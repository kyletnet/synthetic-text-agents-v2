...
export declare abstract class BaseAgent implements IBaseAgent {
    ...
    constructor(id: string, specialization: string, tags: string[], logger: Logger);
    ...
    protected assessConfidence(_result: unknown, _context?: AgentContext): Promise<number>;
    protected explainReasoning(input: unknown, output: unknown, _context?: AgentContext): Promise<string>;
    protected estimateTokensUsed(input: unknown, output: unknown): Promise<number>;
    protected assessQuality(result: unknown, context?: AgentContext): Promise<number>;
