...
export class AgentLogger {
     ...
     */
    logOperationStart(context, agentId, agentRole, operation, inputData, additionalFields) {
     ...
     */
    logOperationComplete(context, agentId, agentRole, operation, startTime, result, additionalFields) {
     ...
     */
    logOperationFailure(context, agentId, agentRole, operation, startTime, error, retryCount = 0, additionalFields) {
        const latencyMs = Date.now() - startTime;
     ...
     */
    logWorkflowStep(context, workflowStep, agentsInvolved, stepResult, additionalFields) {
        const logEntry = {
            timestamp: new Date().toISOString(),
            run_id: context.run_id,
            item_id: context.item_id,
