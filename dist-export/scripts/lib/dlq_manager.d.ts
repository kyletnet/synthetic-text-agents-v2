...
export declare class DLQManager {
     ...
     */
    addFailedItem(runId: string, itemId: string, originalData: any, error: Error, context?: any): DLQItem;
    /**
 ...
 */
export declare function withRetryAndDLQ<T>(operation: () => Promise<T>, runId: string, itemId: string, originalData: any, context?: any, dlqManager?: DLQManager): Promise<T | null>;
