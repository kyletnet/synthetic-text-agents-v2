...
export declare class CheckpointManager {
     ...
     */
    createCheckpoint(runId: string, sessionId: string, progress: {
        total_items: number;
        completed_items: number;
        failed_items: number;
        last_processed_index: number;
    }, state: any, processedItems: ProcessedItem[], checkpointType?: "full" | "incremental" | "emergency"): CheckpointData;
    /**
     * Create emergency checkpoint (for unexpected termination)
     */
    createEmergencyCheckpoint(runId: string, sessionId: string, currentState: any, errorDetails: {
        error: Error;
        context: any;
    }): CheckpointData;
    /**
 ...
 */
export declare function createCheckpointManager(baseDir?: string, config?: Partial<CheckpointConfig>): CheckpointManager;
/**
...
export declare const CheckpointUtils: {
     ...
     */
    withCheckpointing: <T>(operation: () => Promise<T>, checkpointManager: CheckpointManager, context: {
        runId: string;
        sessionId: string;
        itemIndex: number;
        totalItems: number;
