 ...
 */
export declare function calculateCoverageMetrics(qaItems: QAItem[], sourceTexts: string[], configPath?: string): CoverageMetrics;
/**
 * Generate coverage report
 */
export declare function generateCoverageReport(metrics: CoverageMetrics): string;
export {};
