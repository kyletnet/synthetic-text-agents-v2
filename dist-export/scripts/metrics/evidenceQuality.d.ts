 ...
 */
export declare function calculateEvidenceQuality(qaItems: QAItem[], configPath?: string): EvidenceQualityMetrics;
/**
 * Generate evidence quality report
 */
export declare function generateEvidenceReport(metrics: EvidenceQualityMetrics): string;
export {};
