 ...
 */
export declare function scanPiiAndLicense(qaItems: QAItem[], configPath?: string): PiiLicenseMetrics;
/**
 * Generate PII and license scan report
 */
export declare function generatePiiLicenseReport(metrics: PiiLicenseMetrics): string;
export {};
