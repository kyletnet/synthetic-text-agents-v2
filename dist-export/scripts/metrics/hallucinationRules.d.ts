 ...
 */
export declare function detectHallucinations(qaItems: QAItem[], configPath?: string): HallucinationMetrics;
/**
 * Generate hallucination detection report
 */
export declare function generateHallucinationReport(metrics: HallucinationMetrics): string;
export {};
