...
export declare class AnthropicAdapter {
     ...
     */
    callAnthropic(payload: AnthropicChatPayload, opts?: CallOptions): Promise<AdapterResult>;
 ...
 */
export declare function callAnthropic(payload: AnthropicChatPayload, opts?: CallOptions): Promise<AdapterResult>;
/**
...
export declare class LLMAdapter {
    private adapter;
    constructor();
    chatJSONOnly(userPrompt: string, systemPrompt?: string): Promise<{
        text: string;
        usage?: {
            input_tokens?: number;
            output_tokens?: number;
