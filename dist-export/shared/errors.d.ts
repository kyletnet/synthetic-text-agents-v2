...
export declare class AgentExecutionError extends AgentSystemError {
    constructor(agentId: string, message: string, options?: {
        context?: Record<string, unknown>;
        cause?: Error;
    });
}
 ...
 */
export declare function isAgentSystemError(error: unknown): error is AgentSystemError;
export declare function createErrorContext(data: Record<string, unknown>): Record<string, unknown>;
/**
