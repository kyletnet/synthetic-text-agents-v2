 ...
 */
export declare function initializeErrorTracking(
 ...
 */
export declare function trackError(
  error: Error | string,
  context?: ErrorContext,
  severity?: ErrorReport["severity"],
): Promise<void>;
export declare function trackCriticalError(
  error: Error | string,
  context?: ErrorContext,
): Promise<void>;
...
export declare function setUserContext(
