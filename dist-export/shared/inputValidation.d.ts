...
export declare class InputValidator {
     ...
     */
    validate<T>(schema: z.ZodSchema<T>, input: unknown, options?: {
        sanitize?: boolean;
        fieldName?: string;
 ...
 */
export declare function initializeValidator(config?: Partial<ValidationConfig>): InputValidator;
/**
 ...
 */
export declare function validateInput<T>(schema: z.ZodSchema<T>, input: unknown, options?: {
    sanitize?: boolean;
    fieldName?: string;
}): Promise<ValidationResult<T>>;
