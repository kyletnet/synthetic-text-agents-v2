...
export declare class PerformanceMonitor extends EventEmitter {
     ...
     * End a transaction
     */
    endTransaction(transactionId: string, status?: TransactionContext["status"], error?: Error): void;
    /**
...
export declare function initializePerformanceMonitoring(config: APMConfig): PerformanceMonitor;
export declare function getPerformanceMonitor(): PerformanceMonitor | null;
export declare function trackPerformance(metricName?: string): (target: any, propertyKey: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
