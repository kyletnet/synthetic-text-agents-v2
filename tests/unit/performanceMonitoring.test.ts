...
describe('PerformanceMonitor', () => {
  ...
  describe('Transaction Tracking', () => {
    it('should start and end transactions successfully', async () => {
      const transactionId = monitor.startTransaction('test-transaction', 'agent_execution');
    ...
    it('should handle transaction with error', async () => {
      const transactionId = monitor.startTransaction('failing-transaction', 'api_request');
    ...
    it('should record transaction duration metrics', async () => {
      ...
      const transactionId = monitor.startTransaction('timed-transaction', 'agent_execution');
  ...
  describe('Span Tracking', () => {
    it('should create and manage spans within transactions', () => {
      const transactionId = monitor.startTransaction('span-test', 'agent_execution');
    ...
    it('should handle nested spans', () => {
      const transactionId = monitor.startTransaction('nested-spans', 'agent_execution');

      const parentSpanId = monitor.startSpan(transactionId, 'parent-span');
      const childSpanId = monitor.startSpan(transactionId, 'child-span', parentSpanId);
  ...
  describe('Event Handling', () => {
    ...
    it('should emit events for transaction lifecycle', () => {
      ...
      const transactionId = monitor.startTransaction('event-test', 'agent_execution');
      monitor.endTransaction(transactionId, 'success');
