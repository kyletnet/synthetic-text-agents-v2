  ...
  describe("QAPairSchema", () => {
    it("should validate a valid QA pair", () => {
      const validQA = {
        id: "qa-001",
        question:
          "How should customer service representatives handle billing disputes?",
        answer:
          "First, listen actively to understand the specific issue. Then verify account details, investigate the dispute, and work with the customer to find an appropriate resolution while documenting the entire process.",
