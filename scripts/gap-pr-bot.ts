...
class GapPRBot {
  ...
  private generateComment(report: GapScanReport): string {
    ...
    comment += "|----------|-------|--------|\n";
    comment += `| 🔴 P0 Critical | ${summary.P0} | ${
      summary.P0 > 0 ? "⚠️ Action Required" : "✅ Pass"
    } |\n`;
    comment += `| 🟡 P1 High | ${summary.P1} | ${
      summary.P1 > 0 ? "⚠️ Review Needed" : "✅ Pass"
    } |\n`;
    comment += `| 🟢 P2 Medium | ${summary.P2} | ${
      summary.P2 > 0 ? "ℹ️ Minor Issues" : "✅ Pass"
    } |\n`;
    comment += `| **Total** | **${summary.total}** | ${
      summary.total > 0 ? "📝 See Details" : "🎉 All Clear"
    } |\n\n`;
