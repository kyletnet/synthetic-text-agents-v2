...
export default function SmartAugmentPage() {
  ...
  const handleAugmentCountChange = (
      ...
      if (augmentData.success) {
        ...
        SessionLogger.logSession({
          ...
          metadata: {
            ...
            bestVariantScore:
              augmentData.session.evaluation.bestVariants[0]?.quality?.score ||
              0,
          },
        });
      } else {
      ...
      <div className="container mx-auto p-6 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            청크 문서와 골든 QA 예시를 업로드하여 자동으로 데이터를 증강하고
            품질을 평가합니다.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={
                      currentStep >= 1 ? "font-medium" : "text-gray-500"
                    }
                  >
                    1. 문서 업로드
                  </span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={
                      currentStep >= 2 ? "font-medium" : "text-gray-500"
                    }
                  >
                    2. 증강 설정
                  </span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={
                      currentStep >= 3 ? "font-medium" : "text-gray-500"
                    }
                  >
                    3. 자동 실행
                  </span>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-600">
                  <p>
                    • 파일에는 청크 문서와 골든 QA 예시가 함께 포함되어야
                    합니다.
                  </p>
                  <p>
                    • 시스템이 자동으로 문서를 분석하여 적절한 증강을
                    수행합니다.
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Badge
                        variant={
                          result.evaluation.overallScore > 0.7
                            ? "default"
                            : "secondary"
                        }
                      >
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Object.entries(result.evaluation.metrics).map(
                    ([key, metric]) => (
