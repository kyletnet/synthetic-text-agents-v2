...
const docA = fs.readFileSync(
  path.join(root, "dev/runs/sample_docs/docA.md"),
  "utf8",
);
const docB = fs.readFileSync(
  path.join(root, "dev/runs/sample_docs/docB.md"),
  "utf8",
);
